...
#make treemix object
tmx1 = ipa.treemix(
    workdir="/fs/project/wolfe.205/stone.494/project_davidsonii_x_fruticosus/analyses_treemix/m4/rep1",
    data=data,
    imap=imap,
    minmap=minmap,
    root="abietinus",
...
tmx2 = ipa.treemix(
    workdir="/fs/project/wolfe.205/stone.494/project_davidsonii_x_fruticosus/analyses_treemix/m4/rep2",
    data=data,
    imap=imap,
    minmap=minmap,
    root="abietinus",
...
tmx3 = ipa.treemix(
    workdir="/fs/project/wolfe.205/stone.494/project_davidsonii_x_fruticosus/analyses_treemix/m4/rep3",
    data=data,
    imap=imap,
    minmap=minmap,
    root="abietinus",
...
tmx4 = ipa.treemix(
    workdir="/fs/project/wolfe.205/stone.494/project_davidsonii_x_fruticosus/analyses_treemix/m4/rep4",
    data=data,
    imap=imap,
    minmap=minmap,
    root="abietinus",
...
tmx5 = ipa.treemix(
    workdir="/fs/project/wolfe.205/stone.494/project_davidsonii_x_fruticosus/analyses_treemix/m4/rep5",
    data=data,
    imap=imap,
    minmap=minmap,
    root="abietinus",
...
with open('likvals_m4.txt', 'w') as file:
